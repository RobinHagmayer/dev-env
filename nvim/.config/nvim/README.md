...
| [mini.completion](https://github.com/nvim-mini/mini.completion) | Autocompletion | <!-- TODO: why mini.completion over nvim-cmp or built-in? --> |
| [nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) | File icons | Used by different plugins. |
